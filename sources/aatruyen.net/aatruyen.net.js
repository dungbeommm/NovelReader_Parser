/* NovelReader source: aatruyen.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=aatruyen.net","domain":"aatruyen.net","keys":["aatruyen.net","www.aatruyen.net"],"use_html_parser":true,"title":{"selector":"h2.comics-title"},"chapter":{"selector":"h1.chapter-title"},"content":{"selector":".story-content"},"next_button":{"selector":"a.next_page","value":"href","element_indexed":0},"pre_button":{"selector":"a.prev_page","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a[href*=\"/chuong-1-\"]","value":"href","element_indexed":0},"chapter_ignore_domain":true};
  const VERSION = 4;
  const ENGINE = 4;
