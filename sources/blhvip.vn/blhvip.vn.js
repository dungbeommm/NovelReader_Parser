/* NovelReader source: blhvip.vn | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"blhvip.vn","keys":["blhvip.vn","www.blhvip.vn"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1 a[href*=\"/truyen/\"], .breadcrumb a[href*=\"/truyen/\"], a[href*=\"/truyen/\"]"},"chapter":{"selector":"h1, h2, .chapter-title, .entry-title, .title"},"content":{"selector":"#chapter-content, .chapter-content, .reading-content, .entry-content, article, .content, #content"},"next_button":{"selector":"a[rel=next], a.next, .next a, a[href*=\"/chuong-\"]:contains(Sau), a:contains(Chương sau)","value":"href"},"pre_button":{"selector":"a[rel=prev], a.prev, .prev a, a[href*=\"/chuong-\"]:contains(Trước), a:contains(Chương trước)","value":"href"},"detail_first_chapter":{"selector":"a[href*=\"/chuong-1\"], a[href*=\"/chuong-01\"], a[href*=\"/chuong-\"]","value":"href","element_indexed":0},"html_removes":["script","style","ins",".ads",".advertisement",".banner",".comment",".comments","iframe","button",".nav-chapter",".chapter-nav"],"content_removes":[{"start":"Từ khóa:","end":"\n"},{"start":"Bạn đang đọc","end":"\n"}],"search":{"url":"https://blhvip.vn/tim-kiem?keyword=%s","urls":["https://blhvip.vn/tim-kiem?keyword=%s","https://blhvip.vn/search?keyword=%s","https://blhvip.vn/?s=%s"],"item":{"selector":".list-truyen .row, .story-item, .book-item, article, .item, li"},"title":{"selector":"h3 a, h2 a, .title a, a[href*=\"/truyen/\"]"},"link":{"selector":"h3 a, h2 a, .title a, a[href*=\"/truyen/\"]","value":"href"},"cover":{"selector":"img","value":"src"},"story_url_regex":"^https?://[^/]+/truyen/[a-z0-9][a-z0-9-]{2,}/?$","exclude_url_regex":"(chuong|/the-loai|/tag/|/page/|/tim-kiem|/search|\\?s=|/login|/user)","story_url_templates":["https://blhvip.vn/truyen/%d/"],"generated":false}};
  const VERSION = 3;
  const ENGINE = 3;
