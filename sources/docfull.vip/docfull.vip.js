/* NovelReader source: docfull.vip | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://docfull.vip/logo_docfull_vip.png","domain":"docfull.vip","keys":["docfull","docfull.vip"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1"},"chapter":{"selector":"h2"},"content":{"selector":"div[data-chapter-content]"},"detail_first_chapter_js":"(function(){var p=window.location.pathname;return p.endsWith('/')?window.location.origin+p+'chuong-1/':window.location.origin+p+'/chuong-1/';})()","data_ready_checker":["Đang tải nội dung chương"],"next_button":{"selector":".reader-nav-btn-dark","action":1,"element_indexed":3,"value":"href"},"pre_button":{"selector":".reader-nav-btn-dark","element_indexed":0,"action":1,"value":"href"}};
  const VERSION = 4;
  const ENGINE = 4;
