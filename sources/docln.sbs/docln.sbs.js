/* NovelReader source: docln.sbs | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=docln.sbs","domain":"docln.sbs","keys":["docln.net","docln.sbs","www.docln.sbs"],"use_html_parser":true,"use_webview":true,"title":{"selector":".rd_sidebar-name h5 a"},"chapter":{"selector":".title-top h4"},"content":{"selector":"#chapter-content"},"next_button":{"selector":"a.rd_sd-button_item.rd_top-right","value":"href"},"pre_button":{"selector":"a.rd_sd-button_item.rd_top-left","value":"href"},"data_ready_checker":["chapter-c-protected"],"detail":{"name":{"selector":"h1, .series-name, .series-title"},"author":{"selector":".info-item a, a[href*='tac-gia'], .author"},"description":{"selector":".summary, .series-summary, .description"}},"cover":{"selector":".series-cover img, .content-top img, .thumb img","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
