/* NovelReader source: docln.sbs | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"docln.sbs","keys":["docln.sbs","www.docln.sbs","docln.net"],"use_html_parser":true,"use_webview":true,"title":{"selector":".rd_sidebar-name h5 a"},"chapter":{"selector":".title-top h4"},"content":{"selector":"#chapter-content"},"next_button":{"selector":"a.rd_sd-button_item.rd_top-right","value":"href"},"pre_button":{"selector":"a.rd_sd-button_item.rd_top-left","value":"href"},"data_ready_checker":["chapter-c-protected"],"detail":{"name":{"selector":".series-name a, .series-name"},"author":{"selector":".series-owner_name a, .info-item a[href*='tac-gia']"},"description":{"selector":".summary-content"},"genres":{"selector":".series-gerne-item"},"status":{"selector":".info-item:contains(Tình trạng) .info-value"}},"toc":{"selector":".list-chapters a, .chapter-name a"}};
  const VERSION = 3;
  const ENGINE = 3;
