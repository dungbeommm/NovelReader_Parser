/* NovelReader source: dualeotruyenfull.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://dualeotruyenfull.net/wp-content/uploads/2025/12/cropped-favicon-192x192.webp","domain":"dualeotruyenfull.net","keys":["dualeotruyenfull.net","www.dualeotruyenfull.net"],"use_html_parser":true,"use_webview":false,"title":{"selector":"#breadcrumb-manga","value":"text"},"chapter":{"selector":"h1","value":"text","element_indexed":0},"content":{"selector":".chapter-body"},"next_button":{"selector":"#next-link","value":"href"},"pre_button":{"selector":"#prev-link","value":"href"},"detail_first_chapter":{"selector":"a.uk-button-primary[href*=\"chuong-1\"]","value":"href","element_indexed":0},"detail":{"name":{"selector":"h3.title, h1, .truyen-title"},"author":{"selector":"a[itemprop=author], div.info div a"},"description":{"selector":"div.desc-text, .desc-text"},"genres":{"selector":".info a[itemprop=genre], a[itemprop=genre]"},"status":{"selector":"div.info .text-success, div.info span"}},"cover":{"selector":"div.book img, .book img, .book-img img","value":"src"},"toc":{"selector":".list-chapter li a"},"search":{"url":"https://dualeotruyenfull.net/tim-kiem/?tukhoa=%s","item":{"selector":".list-truyen div[itemscope], .list-truyen .row"},"title":{"selector":".truyen-title a, .truyen-title"},"link":{"selector":".truyen-title a","value":"href"},"cover":{"selector":"[data-image]","value":"data-image"},"author":{"selector":".author"}},"toc_ajax":{"id_selector":"input#truyen-id","ascii_selector":"input#truyen-ascii","total_page_selector":"input#total-page","url_template":"/ajax.php?type=list_chapter&tid={tid}&tascii={tascii}&page={page}&totalp={total}","list_selector":".list-chapter li a"}};
  const VERSION = 4;
  const ENGINE = 4;
