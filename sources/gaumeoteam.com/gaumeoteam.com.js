/* NovelReader source: gaumeoteam.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://gaumeoteam.com/favicon.ico","domain":"gaumeoteam.com","keys":["gaumeoteam.com"],"use_html_parser":true,"use_webview":false,"title":{"selector":".breadcrumb a","value":"text","element_indexed":1},"chapter":{"selector":"#chapter-heading","value":"text"},"content":{"selector":".reading-content"},"next_button":{"selector":".nav-next a","value":"href","element_indexed":0},"pre_button":{"selector":".nav-previous a","value":"href","element_indexed":0},"detail_first_chapter_js":"(function(){var p=window.location.pathname;if(p.charAt(p.length-1)!=='/')p+='/';return window.location.origin+p+'chuong-1/';})()"};
  const VERSION = 4;
  const ENGINE = 4;
