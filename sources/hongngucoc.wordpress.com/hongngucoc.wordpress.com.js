/* NovelReader source: hongngucoc.wordpress.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://hongngucoc.wordpress.com/favicon.ico","domain":"hongngucoc.wordpress.com","keys":["hongngucoc.wordpress.com"],"use_html_parser":true,"use_webview":false,"title":{"selector":".entry-title","value":"text"},"chapter":{"selector":".entry-title","value":"text"},"content":{"selector":".entry-content"},"html_removes":[{"selector":"#jp-post-flair"},{"selector":".sharedaddy"},{"selector":".jp-relatedposts"}],"next_button":{"selector":"a[rel=next]","value":"href"},"pre_button":{"selector":"a[rel=prev]","value":"href"},"detail_first_chapter":{"selector":".entry-content a[href*=\"-chuong-\"]","value":"href","element_indexed":0}};
  const VERSION = 4;
  const ENGINE = 4;
