/* NovelReader source: itruyenchuz.org | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"itruyenchuz.org","keys":["itruyenchuz.org","www.itruyenchuz.org"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1","value":"text"},"chapter":{"selector":".chapter-title","value":"text"},"content":{"selector":".content"},"detail_first_chapter":{"selector":"a[href$=\"/chuong-1\"]","value":"href","element_indexed":0}};
  const VERSION = 3;
  const ENGINE = 3;
