/* NovelReader source: itruyenchuz.org | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=itruyenchuz.org","domain":"itruyenchuz.org","keys":["itruyenchuz.org","www.itruyenchuz.org"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1","value":"text"},"chapter":{"selector":".chapter-title","value":"text"},"content":{"selector":"article"},"detail_first_chapter":{"selector":"a[href$=\"/chuong-1\"]","value":"href","element_indexed":0},"detail":{"name":{"selector":"h1"},"author":{"selector":"[itemProp=author], [itemprop=author]"},"description":{"selector":"[itemProp=description], [itemprop=description]"},"genres":{"selector":"[itemProp=genre], [itemprop=genre]"}},"cover":{"selector":"[itemProp=thumbnailUrl], meta[itemprop=thumbnailUrl]","value":"content"}};
  const VERSION = 4;
  const ENGINE = 4;
