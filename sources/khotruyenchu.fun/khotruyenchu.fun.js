/* NovelReader source: khotruyenchu.fun | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"khotruyenchu.fun","keys":["khotruyenchu.fun"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1"},"chapter":{"selector":"h1"},"content":{"selector":".entry-content"},"content_replaces":["≣ Mục lục","Chương sau »","« Chương trước"],"next_button":{"selector":".nav-next a","value":"href"},"pre_button":{"selector":".nav-prev a","value":"href"},"detail_first_chapter":{"selector":".btn-chuong-1","value":"href"}};
  const VERSION = 3;
  const ENGINE = 3;
