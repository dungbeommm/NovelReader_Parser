/* NovelReader source: khotruyenchu.fun | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://khotruyenchu.fun/wp-content/uploads/2025/12/cropped-Logo-2-300x300.png","domain":"khotruyenchu.fun","keys":["khotruyenchu.fun"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1"},"chapter":{"selector":"h1"},"content":{"selector":"article"},"content_replaces":["≣ Mục lục","Chương sau »","« Chương trước"],"next_button":{"selector":".nav-next a","value":"href"},"pre_button":{"selector":".nav-prev a","value":"href"},"detail_first_chapter":{"selector":".btn-chuong-1","value":"href"},"detail":{"name":{"selector":"h1"},"author":{"selector":"[itemProp=author], [itemprop=author]"},"description":{"selector":"[itemProp=description], [itemprop=description]"},"genres":{"selector":"[itemProp=genre], [itemprop=genre]"}},"cover":{"selector":"[itemProp=thumbnailUrl], meta[itemprop=thumbnailUrl]","value":"content"}};
  const VERSION = 4;
  const ENGINE = 4;
