/* NovelReader source: lovetruyen.pro | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"lovetruyen.pro","use_html_parser":true,"may_need_vpn":true,"key":"lovetruyen","title":{"selector":".story-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":"#chapter-content"},"next_button":{"selector":".chapter-button a","element_indexed":2,"value":"href"},"pre_button":{"selector":".chapter-button a","element_indexed":0,"value":"href"},"chapter_ignore_domain":true,"detail_first_chapter":{"selector":"a.read-btn","value":"href"},"logo":"https://lovetruyen.me/favicon.ico","keys":["lovetruyen.pro"]};
  const VERSION = 4;
  const ENGINE = 4;
