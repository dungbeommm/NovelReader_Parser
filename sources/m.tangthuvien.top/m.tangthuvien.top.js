/* NovelReader source: m.tangthuvien.top | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://play-lh.googleusercontent.com/ySl8uNRjXrdZoY4xJZWZ0A875z4lTVLvJckaE3ECsL8OitY0g5UES9QMpNhO7OO1hH4=w480-h960-rw","domain":"m.tangthuvien.top","may_need_vpn":true,"key":"tangthuvien","enable_download":false,"chapter":{"selector":".page-title","value":"text"},"content":{"selector":".chap-c","value":"text"},"next_button":{"selector":".pull-right","action":1},"pre_button":{"selector":".control-chap a","action":1},"use_webview":true,"use_html_parser":true,"data_loading_checker":["id=\"control-chap\""],"detail_first_chapter":{"selector":"#btnReadBook","value":"href"},"keys":["m.tangthuvien.top"],"detail":{"name":{"selector":"h1"},"author":{"selector":"div.book-information div.book-info a, .book-info a"},"description":{"selector":"div.book-info-detail div.book-intro, .book-intro"},"genres":{"selector":"li.tags .detail a.tags, a.tags"},"status":{"selector":"p.tag, .tag"}},"cover":{"selector":"div.book-img img, .book-img img","value":"src"},"toc":{"selector":"div.volume-list li a, .chapter-list a, li a[href*='chuong']"},"search":{"url":"https://m.tangthuvien.top/ket-qua-tim-kiem?term=%s","item":{"selector":"#rank-view-list ul li, .rank-view-list li"},"title":{"selector":"h4 a, h4 > a"},"link":{"selector":"h4 a","value":"href"},"cover":{"selector":"img","value":"src"},"author":{"selector":".author"}}};
  const VERSION = 4;
  const ENGINE = 4;
