/* NovelReader source: metruyencv.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"metruyencv.com","keys":["metruyencv.com","www.metruyencv.com","metruyenchu.com","mtccv.com","metruyencv.biz","www.metruyencv.biz","truyencv.com","www.truyencv.com","mottruyen.com","api.mottruyen.com"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1, .book-title, .story-title"},"chapter":{"selector":"h1.chapter-title, .chapter-title, h2"},"content":{"selector":"#chapter-content, .chapter-content, .content, article"},"next_button":{"selector":"a[rel=next], .next-chapter a, #next_chap","value":"href"},"pre_button":{"selector":"a[rel=prev], .prev-chapter a, #prev_chap","value":"href"},"detail_first_chapter":{"selector":"a[href*='/chuong-'], a[href*='/chapter-']","value":"href","element_indexed":0},"detail":{"name":{"selector":"h1.text-center, h1"},"author":{"selector":"a[href*='tac-gia'], .author a"},"description":{"selector":"div.content.text-base, .story-detail, [itemprop=description]"},"genres":{"selector":"a[href*='the-loai'], a[href*='genre']"},"status":{"selector":".text-green-600, .status"}},"toc":{"selector":".chapter-list a, #chapter-list a"}};
  const VERSION = 3;
  const ENGINE = 3;
