/* NovelReader source: metruyenhot.me | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://metruyenhot.me/frontend/images/logo.png","domain":"metruyenhot.me","keys":["metruyenhot.me","metruyenhotmoi.com","www.metruyenhot.me","www.metruyenhotmoi.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1.rv-full-story-title","value":"text"},"chapter":{"selector":".rv-chapt-title h2 > a","value":"text"},"content":{"selector":".chapter-c"},"next_button":{"selector":"li.detail-chapter-btn a","value":"href","action":0,"element_indexed":1},"pre_button":{"selector":"li.detail-chapter-btn a","value":"href","action":0,"element_indexed":0},"data_loading_checker":[],"data_ready_checker":[],"chapter_ignore_domain":false,"detail_first_chapter":{"selector":".list-chap ul li:first-child a","value":"href"},"detail":{"name":{"selector":"h1, .story-title, .novel-title"},"author":{"selector":"a[href*='tac-gia'], .author a, .author"},"description":{"selector":".content, .summary, .description, .story-detail"}},"cover":{"selector":".book img, .cover img, .story-cover img, img.cover","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
