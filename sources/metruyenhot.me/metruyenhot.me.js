/* NovelReader source: metruyenhot.me | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"metruyenhot.me","keys":["metruyenhot.me","www.metruyenhot.me","metruyenhotmoi.com","www.metruyenhotmoi.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1.rv-full-story-title","value":"text"},"chapter":{"selector":".rv-chapt-title h2 > a","value":"text"},"content":{"selector":".chapter-c"},"next_button":{"selector":"li.detail-chapter-btn a","value":"href","action":0,"element_indexed":1},"pre_button":{"selector":"li.detail-chapter-btn a","value":"href","action":0,"element_indexed":0},"data_loading_checker":[],"data_ready_checker":[],"chapter_ignore_domain":false,"detail_first_chapter":{"selector":".list-chap ul li:first-child a","value":"href"}};
  const VERSION = 3;
  const ENGINE = 3;
