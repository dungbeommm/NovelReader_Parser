/* NovelReader source: metruyensangtac.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"metruyensangtac.com","keys":["metruyensangtac.com","www.metruyensangtac.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h3.chuong_ten","element_indexed":0},"chapter":{"selector":"h3.chuong_ten","element_indexed":0},"content":{"selector":".chapter-content .content-text"},"next_button":{"selector":".next-chapter a.nav-chapter-btn","value":"href","element_indexed":0},"pre_button":{"selector":".prev-chapter a.nav-chapter-btn","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"div.book-3d a[href*=\"/read/\"]","value":"href","element_indexed":0},"data_loading_checker":["chapter-content"],"data_ready_checker":[],"chapter_ignore_domain":true,"logo":"https://metruyensangtac.com/favicon.ico","detail":{"name":{"selector":"h1, .story-title, .novel-title"},"author":{"selector":"a[href*='tac-gia'], .author a, .author"},"description":{"selector":".content, .summary, .description, .story-detail"}},"cover":{"selector":".book img, .cover img, .story-cover img, img.cover","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
