/* NovelReader source: mongtruyen.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://mongtruyen.com/img_data/images/mong-truyen/android-chrome-512x512.png","domain":"mongtruyen.com","keys":["mongtruyen","mongtruyen.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":".breadcrumb-item","element_indexed":2},"chapter":{"selector":".mdv-san-pham-detail-chuong-title-text"},"content":{"selector":"#noi_dung_truyen"},"next_button":{"selector":".mdv-chuong-button-sau","value":"href"},"pre_button":{"selector":".mdv-chuong-button-truoc","value":"href"},"detail_first_chapter":{"selector":".san-pham-show-read-next-btn a[href*='?chuong=1']","value":"href","element_indexed":0},"content_load_js":"(function(){try{if(typeof window.mtLoadChapterContent==='function'){window.mtLoadChapterContent({force:true,silent:true,retries:2,retryDelayMs:600});}}catch(e){}})()","data_ready_checker":["Vui lòng bật JavaScript để xem nội dung chương"]};
  const VERSION = 4;
  const ENGINE = 4;
