/* NovelReader source: navyteams.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"navyteams.com","keys":["navyteam","navyteamz","navyteams"],"title":{"start":"<title>","end":"- Chương"},"chapter":{"start":"id=\"chapterTitle\">","end":"</div>"},"content":{"start":"id=\"novelContent\">","middle":"</strong></p>","end":"</p>                            </div>"}};
  const VERSION = 3;
  const ENGINE = 3;
