/* NovelReader source: navyteams.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://navyteamz.com/storage/site/UTXsBXH3MCbGasHyEXINMrWKSqzTCkRL865M2PMl.png","domain":"navyteams.com","keys":["navyteam","navyteams","navyteams.com","navyteamz"],"title":{"start":"<title>","end":"- Chương"},"chapter":{"start":"id=\"chapterTitle\">","end":"</div>"},"content":{"start":"id=\"novelContent\">","middle":"</strong></p>","end":"</p>                            </div>"},"use_html_parser":true};
  const VERSION = 4;
  const ENGINE = 4;
