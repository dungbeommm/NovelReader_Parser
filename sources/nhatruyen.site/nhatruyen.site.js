/* NovelReader source: nhatruyen.site | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://nhatruyen.site/wp-content/uploads/2026/02/cropped-Nhatruyen_Logo-192x192.jpg","domain":"nhatruyen.site","keys":["nhatruyen.site","www.nhatruyen.site"],"use_html_parser":true,"use_webview":true,"title":{"selector":"ol.breadcrumb li a[href*='/truyen/']"},"chapter":{"selector":"h1.page-title"},"content":{"selector":".entry-content"},"content_replaces":["[COTENT]"],"next_button":{"selector":".story-navigation-container a","value":"href","element_indexed":1},"pre_button":{"selector":".story-navigation-container a","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a.nt-btn-first","value":"href"},"chapter_ignore_domain":true};
  const VERSION = 4;
  const ENGINE = 4;
