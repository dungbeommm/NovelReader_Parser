/* NovelReader source: noveltoon.vn | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://noveltoon.vn/official/noveltoon/icon-128.png","domain":"noveltoon.vn","keys":["noveltoon","noveltoon.vn"],"use_html_parser":true,"title":{"selector":".watch-main-title"},"chapter":{"selector":".watch-chapter-title"},"content":{"selector":".watch-chapter-detail"},"next_button":{"selector":".bottom-bar a","value":"href","element_indexed":1},"pre_button":{"selector":".bottom-bar a","value":"href"},"chapter_ignore_domain":true,"enable_download":false};
  const VERSION = 4;
  const ENGINE = 4;
