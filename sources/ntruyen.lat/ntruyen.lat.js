/* NovelReader source: ntruyen.lat | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://ntruyen.xyz/imgs/logo.webp","domain":"ntruyen.lat","keys":["ntruyen.lat","ntruyen.xyz"],"title":{"selector":"h1"},"chapter":{"selector":"h1"},"content":{"selector":".wrapper.prose"},"next_button":{"selector":"a[rel='nofollow']","element_indexed":1,"value":"href"},"pre_button":{"selector":"a[rel='nofollow']","element_indexed":0,"value":"href"},"use_webview":true,"use_html_parser":true,"chapter_ignore_domain":true,"data_loading_checker":["wrapper prose"],"data_ready_checker":[],"detail_first_chapter_js":"(function(){var a=document.querySelector('a[href*=\"/doc-truyen/\"]');return a?a.href:'';  })()"};
  const VERSION = 4;
  const ENGINE = 4;
