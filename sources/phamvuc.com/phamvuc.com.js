/* NovelReader source: phamvuc.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"phamvuc.com","keys":["phamvuc.com","www.phamvuc.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1"},"chapter":{"selector":"h2"},"content":{"selector":"#chapterContent"},"next_button":{"selector":"a[title=\"Chương sau\"]","value":"href"},"pre_button":{"selector":"a[title=\"Chương trước\"]","value":"href"},"detail_first_chapter":{"selector":"a[href*='/chuong-1']","value":"href"},"data_loading_checker":["chapterContent"],"logo":"https://phamvuc.com/assets/images/logo.jpg?v=5"};
  const VERSION = 4;
  const ENGINE = 4;
