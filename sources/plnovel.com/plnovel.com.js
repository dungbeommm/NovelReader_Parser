/* NovelReader source: plnovel.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=plnovel.com","domain":"plnovel.com","keys":["plnovel.com","www.plnovel.com"],"use_html_parser":false,"title":{"start":"class=\"truyen-title\"","middle":">","end":"</a>"},"chapter":{"start":"class=\"chapter-title\"","middle":">","end":"</a>"},"content":{"start":"textContent\">","middle":"\n","end":"</script>"},"next_button":{"start":"id=\"next_chap\" href=\"","end":"\""},"pre_button":{"start":"id=\"prev_chap\" href=\"","end":"\""},"chapter_ignore_domain":true,"detail_first_chapter_js":"(function(){var b=document.querySelector('#danh-sach-chuong');if(b&&b.nextElementSibling&&b.nextElementSibling.tagName==='A'&&b.nextElementSibling.href)return b.nextElementSibling.href;var l=document.querySelector('a[href*=\"/chuong-1/\"]');return l&&l.href?l.href:'';})()"};
  const VERSION = 4;
  const ENGINE = 4;
