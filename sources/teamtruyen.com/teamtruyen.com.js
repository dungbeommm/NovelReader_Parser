/* NovelReader source: teamtruyen.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"teamtruyen.com","keys":["teamtruyen","teamtruyen.com"],"use_html_parser":true,"use_webview":true,"enable_download":true,"title":{"selector":"h1.stitle"},"chapter":{"selector":"h1"},"content":{"selector":"#chapter-content, .chapter-content, .reading-content, article.content, .content-chapter"},"next_button":{"selector":"a[title='Chương sau'], a:contains(Chương sau)","value":"href"},"pre_button":{"selector":"a[title='Chương trước'], a:contains(Chương trước)","value":"href"},"detail_first_chapter":{"selector":"a[href*='/chuong-1']","value":"href"},"data_loading_checker":["Đang tải"],"logo":"https://teamtruyen.com/images/brand/logo-64.png"};
  const VERSION = 4;
  const ENGINE = 4;
