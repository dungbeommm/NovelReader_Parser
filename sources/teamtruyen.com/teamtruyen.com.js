/* NovelReader source: teamtruyen.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"teamtruyen.com","keys":["teamtruyen.com","teamtruyen"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1.stitle"},"chapter":{"selector":"h1"},"content":{"selector":"#chapter-content, .chapter-content, .reading-content, article.content, .content-chapter"},"next_button":{"selector":"a[title='Chương sau'], a:contains(Chương sau)","value":"href"},"pre_button":{"selector":"a[title='Chương trước'], a:contains(Chương trước)","value":"href"},"detail_first_chapter":{"selector":"a[href*='/chuong-1']","value":"href"},"data_loading_checker":["Đang tải"]};
  const VERSION = 3;
  const ENGINE = 3;
