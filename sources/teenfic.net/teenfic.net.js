/* NovelReader source: teenfic.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://teenfic.net/favicon.ico","domain":"teenfic.net","keys":["teenfic.net","www.teenfic.net"],"use_html_parser":true,"use_webview":true,"title":{"selector":".breadcrumb a[itemprop=\"item\"]","value":"text","element_indexed":1},"chapter":{"selector":".chapter-title","value":"text"},"content":{"selector":".chapter-content"},"next_button":{"selector":"a.nextChapter","value":"href"},"pre_button":{"selector":"a.prevChapter","value":"href"},"data_loading_checker":["chapter-content"],"content_load_js":"void 0;","detail_first_chapter_js":"(function(){var uls=document.querySelectorAll('ul.chapters');var best=null,mx=0;uls.forEach(function(u){var n=u.querySelectorAll('a[href]').length;if(n>mx){mx=n;best=u;}});if(best){var a=best.querySelector('a[href]');if(a)return a.href;}return '';})()"};
  const VERSION = 4;
  const ENGINE = 4;
