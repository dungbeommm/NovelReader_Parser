/* NovelReader source: thungtruyen.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=thungtruyen.com","domain":"thungtruyen.com","keys":["thungtruyen.com","www.thungtruyen.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":".reader-topbar__story","value":"text"},"chapter":{"selector":"h1","value":"text"},"content":{"selector":".reader-article__content"},"detail_first_chapter":{"selector":"a[href*=\"/chuong-\"]","value":"href","element_indexed":0},"data_loading_checker":["reader-article__content"],"content_load_js":"void 0;","chapter_ignore_domain":true};
  const VERSION = 4;
  const ENGINE = 4;
