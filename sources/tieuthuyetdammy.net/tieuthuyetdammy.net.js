/* NovelReader source: tieuthuyetdammy.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://tieuthuyetdammy.net/wp-content/themes/imanga/assets/images/logo.png","domain":"tieuthuyetdammy.net","keys":["tieuthuyetdammy.net","www.tieuthuyetdammy.net"],"use_html_parser":true,"use_webview":true,"title":{"selector":".sky-read-content .title > a","value":"text"},"chapter":{"selector":"h1.title","value":"text"},"content":{"selector":"#js-sky-content"},"next_button":{"selector":"a.btn-sky:has(i.icon-next-bold)","value":"href","element_indexed":0},"pre_button":{"selector":"a.btn-sky:has(i.icon-prev-bold)","value":"href","element_indexed":0},"detail_first_chapter":{"selector":".buttons a.btn-sky","value":"href","element_indexed":0},"data_loading_checker":[],"data_ready_checker":[],"chapter_ignore_domain":false};
  const VERSION = 4;
  const ENGINE = 4;
