/* NovelReader source: truyen.tangthuvien.vn | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"truyen.tangthuvien.vn","may_need_vpn":true,"key":"tangthuvien","chapter":{"selector":".page-title","value":"text"},"content":{"selector":".chap-c","value":"text"},"next_button":{"selector":".pull-right","action":1},"pre_button":{"selector":".control-chap a","action":1},"use_webview":true,"use_html_parser":true,"data_loading_checker":["id=\"control-chap\""],"detail_first_chapter":{"selector":"#btnReadBook","value":"href"},"keys":["truyen.tangthuvien.vn","tangthuvien.vn","tangthuvien.net"],"detail":{"name":{"selector":"div.book-information h1"},"author":{"selector":"div.book-information div.book-info a"},"description":{"selector":"div.book-info-detail div.book-intro"},"genres":{"selector":"li.tags .detail a.tags, .book-info a.blue"},"status":{"selector":"p.tag span"}},"cover":{"selector":"div.book-img img","value":"src"},"toc":{"selector":"#max-volume ul li a, .volume-wrap li a"}};
  const VERSION = 3;
  const ENGINE = 3;
