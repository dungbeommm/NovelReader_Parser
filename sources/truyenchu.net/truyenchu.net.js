/* NovelReader source: truyenchu.net | Generated from app parser.json. */
(function (global) {
  "use strict";

  const config = {"domain":"truyenchu.net","keys":["truyenchu.com.vn","truyenchu.net","truyenchu.vn","www.truyenchu.net"],"use_html_parser":true,"use_webview":false,"title":{"selector":".c-breadcrumb a[href*=\"/truyen/\"]","value":"text","element_indexed":0},"chapter":{"selector":"h1#chapter-heading","value":"text"},"content":{"selector":".reading-content .text-left"},"next_button":{"selector":"a.next_page","value":"href","element_indexed":0},"pre_button":{"selector":"a.prev_page","value":"href","element_indexed":0},"detail_first_chapter_js":"(function(){var p=window.location.pathname;if(!p.endsWith('/'))p+='/';return window.location.origin+p+'chuong-1/';})()"};
  const VERSION = 2;
