/* NovelReader source: truyenchu.net | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"truyenchu.net","keys":["truyenchu.com.vn","truyenchu.net","truyenchu.vn","www.truyenchu.net"],"use_html_parser":true,"use_webview":false,"title":{"selector":".c-breadcrumb a[href*=\"/truyen/\"]","value":"text","element_indexed":0},"chapter":{"selector":"h1#chapter-heading","value":"text"},"content":{"selector":".reading-content .text-left"},"next_button":{"selector":"a.next_page","value":"href","element_indexed":0},"pre_button":{"selector":"a.prev_page","value":"href","element_indexed":0},"detail_first_chapter_js":"(function(){var p=window.location.pathname;if(!p.endsWith('/'))p+='/';return window.location.origin+p+'chuong-1/';})()","detail":{"name":{"selector":"h1.story-title, h1"},"author":{"selector":"a[href*='tac-gia']"},"description":{"selector":".story-detail, .desc-text"},"genres":{"selector":"a[href*='the-loai']"}},"toc":{"selector":"#chapter-list a, .list-chapter a"}};
  const VERSION = 3;
  const ENGINE = 3;
