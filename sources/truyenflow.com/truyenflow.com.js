/* NovelReader source: truyenflow.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"truyenflow.com","keys":["truyenflow.com","www.truyenflow.com"],"use_html_parser":true,"title":{"selector":"h1"},"chapter":{"selector":"h2"},"content":{"selector":".chapter-content"},"next_button":{"selector":"a[href*=\"/chuong-\"]","value":"href","element_indexed":1},"pre_button":{"selector":"a[href*=\"/chuong-\"]","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a.btn-read","value":"href"},"logo":"https://truyenflow.com/favicon.ico"};
  const VERSION = 4;
  const ENGINE = 4;
