/* NovelReader source: truyenfull.live | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"truyenfull.live","keys":["truyenfull.io","truyenfull.live","truyenfull.today","truyenfull.tv","truyenfull.vision","truyenfull.vn"],"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":"#chapter-c"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".list-chapter li a","value":"href"},"use_html_parser":true,"chapter_ignore_domain":true,"detail":{"name":{"selector":"h3.title"},"author":{"selector":"a[itemprop=author], div.info div a"},"description":{"selector":"div.desc-text"},"genres":{"selector":".info a[itemprop=genre]"},"status":{"selector":".info .text-success, .info span.text-primary"}},"cover":{"selector":"div.book img","value":"src"},"toc":{"selector":".list-chapter li a"}};
  const VERSION = 3;
  const ENGINE = 3;
