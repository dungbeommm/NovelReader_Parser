/* NovelReader source: truyenfull.live | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://static.truyenfull.today/favicons/favicon-192x192.png","domain":"truyenfull.live","keys":["truyenfull.live","truyenfull.today","truyenfull.vision","truyenfull.vn"],"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":"#chapter-c"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".list-chapter li a","value":"href"},"use_html_parser":true,"chapter_ignore_domain":true,"detail":{"name":{"selector":"h3.title, h1, .truyen-title"},"author":{"selector":"a[itemprop=author], div.info div a"},"description":{"selector":"div.desc-text, .desc-text"},"genres":{"selector":".info a[itemprop=genre], a[itemprop=genre]"},"status":{"selector":"div.info .text-success, div.info span"}},"cover":{"selector":"div.book img, .book img, .book-img img","value":"src"},"toc":{"selector":".list-chapter li a"},"search":{"url":"https://dualeotruyenfull.net/tim-kiem/?tukhoa=%s","item":{"selector":".list-truyen div[itemscope], .list-truyen .row"},"title":{"selector":".truyen-title a, .truyen-title"},"link":{"selector":".truyen-title a","value":"href"},"cover":{"selector":"[data-image]","value":"data-image"},"author":{"selector":".author"}},"toc_ajax":{"id_selector":"input#truyen-id","ascii_selector":"input#truyen-ascii","total_page_selector":"input#total-page","url_template":"/ajax.php?type=list_chapter&tid={tid}&tascii={tascii}&page={page}&totalp={total}","list_selector":".list-chapter li a"}};
  const VERSION = 4;
  const ENGINE = 4;
