/* NovelReader source: truyenhoan.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=truyenhoan.com","domain":"truyenhoan.com","keys":["truyenhoan.com","www.truyenhoan.com"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1","value":"text","element_indexed":0},"chapter":{"selector":".chapter-title","value":"text"},"content":{"selector":"#chapter-c"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":"a[href$=\"chuong-1.html\"]","value":"href","element_indexed":0}};
  const VERSION = 4;
  const ENGINE = 4;
