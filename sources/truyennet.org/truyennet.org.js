/* NovelReader source: truyennet.org | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"truyennet.org","keys":["truyennet.org","www.truyennet.org"],"use_html_parser":true,"title":{"selector":"h1.current-book"},"chapter":{"selector":"h2.current-chapter"},"content":{"selector":"div#story"},"next_button":{"selector":"a.next","value":"href","element_indexed":0},"pre_button":{"selector":"a.back","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a:has(span.btn_truyen)","value":"href","element_indexed":0},"search":{"url":"https://truyennet.org/tim-kiem?s=%s","urls":["https://truyennet.org/tim-kiem?s=%s"],"item":{"selector":".truyen-list .item"},"title":{"selector":"h3 a"},"link":{"selector":"h3 a, a.cover","value":"href"},"author":{"selector":"p.line"},"cover":{"selector":"a.cover img, img","value":"src"},"story_url_regex":"^https?://(?:www\\.)?truyennet\\.org/[a-zA-Z0-9][a-zA-Z0-9-]{2,}/?$","exclude_url_regex":"(chuong|chapter|/tim-kiem|/the-loai|/danh-sach|/tac-gia|/tag/|/page/|/user)","story_url_templates":["https://truyennet.org/%d/"],"generated":false,"headers":{"User-Agent":"Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) vBook TruyenNet/1.0"},"response_type":"html"},"use_webview":false};
  const VERSION = 3;
  const ENGINE = 3;
