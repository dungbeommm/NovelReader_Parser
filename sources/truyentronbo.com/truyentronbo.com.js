/* NovelReader source: truyentronbo.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?sz=128&domain=truyentronbo.com","domain":"truyentronbo.com","keys":["truyentronbo.com","www.truyentronbo.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":".reading-container h3 a","value":"text"},"chapter":{"selector":"h2","value":"text"},"content":{"selector":"#reading-content"},"html_removes":[{"selector":"#reading-content style"},{"selector":".chapter-lock-banner"}],"content_load_js":"(function(){var n=0;var iv=setInterval(function(){n++;var b=document.querySelector('.chapter-lock-banner button');if(b){b.click();}var rc=document.querySelector('#reading-content');var tx=rc?(rc.textContent||''):'';if(rc&&rc.querySelectorAll('p').length>=3&&!document.querySelector('.chapter-lock-banner')&&tx.indexOf('Đang tải')<0){if(!document.getElementById('__ttbready')){var m=document.createElement('div');m.id='__ttbready';m.style.display='none';document.body.appendChild(m);}clearInterval(iv);}if(n>60){clearInterval(iv);}},250);})();","data_loading_checker":["__ttbready"],"next_button":{"selector":"a.nav-btn:not(.btn-secondary)","value":"href","element_indexed":0},"pre_button":{"selector":"a.nav-btn.btn-secondary","value":"href","element_indexed":0},"detail_first_chapter":{"selector":".chapter-item","value":"href","element_indexed":0},"chapter_ignore_domain":true};
  const VERSION = 4;
  const ENGINE = 4;
