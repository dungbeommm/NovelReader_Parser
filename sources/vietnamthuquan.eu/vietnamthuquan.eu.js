/* NovelReader source: vietnamthuquan.eu | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"vietnamthuquan.eu","keys":["vietnamthuquan"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h2"},"chapter":{"selector":".chuongso"},"content":{"selector":"#fontchu"},"next_button":{"selector":"h1 span:last-child","value":"href","action":1},"pre_button":{"selector":"h1 span","value":"href","action":1}};
  const VERSION = 3;
  const ENGINE = 3;
