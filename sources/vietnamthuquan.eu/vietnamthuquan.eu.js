/* NovelReader source: vietnamthuquan.eu | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"vietnamthuquan.eu","keys":["vietnamthuquan","vietnamthuquan.eu"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h2"},"chapter":{"selector":".chuongso"},"content":{"selector":"#fontchu"},"next_button":{"selector":"h1 span:last-child","value":"href","action":1},"pre_button":{"selector":"h1 span","value":"href","action":1}};
  const VERSION = 4;
  const ENGINE = 4;
