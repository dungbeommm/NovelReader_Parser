/* NovelReader source: vnthuquan.org | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"vnthuquan.org","keys":["vnthuquan","vnthuquan.org"],"use_html_parser":true,"title":{"selector":"h1"},"chapter":{"selector":".chuongso_a","element_indexed":1},"content":{"selector":"#vntqTextContent"}};
  const VERSION = 4;
  const ENGINE = 4;
