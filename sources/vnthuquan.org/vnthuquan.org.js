/* NovelReader source: vnthuquan.org | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"vnthuquan.org","keys":["vnthuquan"],"use_html_parser":true,"title":{"selector":"h1"},"chapter":{"selector":".chuongso_a","element_indexed":1},"content":{"selector":"#vntqTextContent"}};
  const VERSION = 3;
  const ENGINE = 3;
