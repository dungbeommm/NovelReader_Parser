/* NovelReader source: webnovel.vn | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://cdn.webnovel.vn/img/favicon.ico","domain":"webnovel.vn","keys":["webnovel.vn","www.webnovel.vn"],"use_html_parser":true,"use_webview":false,"title":{"selector":"h1.reader__title a","value":"text"},"chapter":{"selector":"p.reader__chapter","value":"text"},"content":{"selector":"#chapter-c"},"next_button":{"selector":"a[rel=\"next\"]","value":"href","element_indexed":0},"pre_button":{"selector":"a[rel=\"prev\"]","value":"href","element_indexed":0},"detail_first_chapter_js":"(function(){var p=window.location.pathname;if(!p.endsWith('/'))p+='/';return window.location.origin+p+'chuong-1/';})()"};
  const VERSION = 4;
  const ENGINE = 4;
