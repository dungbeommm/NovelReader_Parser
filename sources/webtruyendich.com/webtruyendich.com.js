/* NovelReader source: webtruyendich.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"webtruyendich.com","keys":["webtruyendich","webtruyendich.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":"a.text-center[href^=\"/truyen/\"]","value":"text","element_indexed":0},"chapter":{"selector":"h1"},"content":{"selector":"#article"},"next_button":{"selector":".next-link","value":"href"},"pre_button":{"selector":".pre-link","value":"href"},"data_loading_checker":["class=\"fade-in-paragraph"],"content_load_js":"void 0;"};
  const VERSION = 4;
  const ENGINE = 4;
