/* NovelReader source: wikicv.org | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://truyenwikidich.net/static/img/logo-wiki-b.gif","domain":"wikicv.org","keys":["truyenwikidich","wikicv","wikicv.org","wikidich.info"],"use_html_parser":true,"title":{"selector":".book-title"},"chapter":{"selector":".book-title","element_indexed":1},"content":{"selector":"#bookContentBody, #bookContent"},"next_button":{"selector":"#btnNextChapter","value":"href"},"pre_button":{"selector":"#btnPreChapter","value":"href"},"detail_first_chapter":{"selector":".control-btns a.orange-btn","value":"href"},"content_removes":[{"start":"║༺☆༻","end":"༺☆༻║"},{"start":"║༺★༻","end":"༺★༻║"},{"start":"close Advertisements","end":"Powered by GliaStudios"}],"content_replaces":["·"],"detail":{"name":{"selector":".book-title, h1"},"author":{"selector":"a[href*='tac-gia'], .book-author, .author"},"description":{"selector":".book-desc, .description, #bookIntro"}},"cover":{"selector":".book-cover img, .book-img img, img.cover","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
