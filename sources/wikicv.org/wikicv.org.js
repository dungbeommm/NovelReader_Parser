/* NovelReader source: wikicv.org | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"wikicv.org","keys":["wikicv.org","wikicv.net","wikicv","truyenwikidich.net","truyenwikidich","wikidich.com","wikidich.info"],"use_html_parser":true,"title":{"selector":".book-title"},"chapter":{"selector":".book-title","element_indexed":1},"content":{"selector":"#bookContentBody"},"next_button":{"selector":"#btnNextChapter","value":"href"},"pre_button":{"selector":"#btnPreChapter","value":"href"},"detail_first_chapter":{"selector":".control-btns a.orange-btn","value":"href"},"content_removes":[{"start":"║༺☆༻","end":"༺☆༻║"},{"start":"║༺★༻","end":"༺★༻║"},{"start":"close Advertisements","end":"Powered by GliaStudios"}],"content_replaces":["·"],"use_webview":false};
  const VERSION = 3;
  const ENGINE = 3;
