/* NovelReader source: wikidichvn.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"wikidichvn.com","keys":["wikidichvn.com","www.wikidichvn.com"],"logo":"https://www.google.com/s2/favicons?sz=128&domain=wikidichvn.com","use_html_parser":true,"use_webview":false,"title":{"selector":"h1.current-book"},"chapter":{"selector":"h2.current-chapter"},"content":{"selector":"#bookContentBody, #bookContent"},"next_button":{"selector":"a.next","value":"href","element_indexed":0},"pre_button":{"selector":"a.back","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"#chapter-list ul li:first-child a","value":"href","element_indexed":0},"detail":{"name":{"selector":".book-title, h1"},"author":{"selector":"a[href*='tac-gia'], .book-author, .author"},"description":{"selector":".book-desc, .description, #bookIntro"}},"cover":{"selector":".book-cover img, .book-img img, img.cover","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
