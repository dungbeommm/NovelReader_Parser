/* NovelReader source: wuxiaworld.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.wuxiaworld.com/favicon-32x32.png","domain":"wuxiaworld.com","keys":["wuxiaworld.com","www.wuxiaworld.com"],"use_html_parser":true,"title":{"selector":"a[href^=\"/novel/\"] p"},"chapter":{"start":"<title data-rh=\"true\">","middle":" - ","end":"</title>"},"content":{"selector":".fr-view"},"next_button":{"selector":"section a:has(button:contains(NEXT CHAPTER))","value":"href"},"pre_button":{"selector":"section a:contains(PREVIOUS CHAPTER)","value":"href"},"detail_first_chapter":{"selector":"a:contains(START READING)","value":"href"},"chapter_ignore_domain":false};
  const VERSION = 4;
  const ENGINE = 4;
