/* NovelReader source: www.chivi.app | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.chivi.app","keys":["chivi","www.chivi.app"],"use_html_parser":true,"use_webview":true,"title":{"selector":"a.svelte-u6zczp","element_indexed":3},"chapter":{"selector":"h1"},"content":{"selector":".reader"},"next_button":{"selector":"a[data-kbd=\"⌃→\"]","value":"href"},"pre_button":{"selector":"a[data-kbd=\"⌃←\"]","value":"href"},"html_removes":[{"selector":".reader ruby, .reader rt, .reader x-z"}],"data_ready_checker":["svelte-19z0z8p _dirty"],"detail":{"name":{"selector":"h1"},"author":{"selector":"meta[property='og:novel:author']","value":"content"},"description":{"selector":".section-content .intro, .intro"},"status":{"selector":".stat._status"}},"cover":{"selector":".cover source, .cover img","value":"srcset"},"search":{"url":"https://chivi.app/books/query?q=%s","item":{"selector":"book-list > a, a[href*='/books/']"},"title":{"selector":"._title"},"cover":{"selector":"source","value":"srcset"}}};
  const VERSION = 4;
  const ENGINE = 4;
