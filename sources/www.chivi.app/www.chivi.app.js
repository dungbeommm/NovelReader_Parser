/* NovelReader source: www.chivi.app | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.chivi.app","keys":["chivi"],"use_html_parser":true,"use_webview":true,"title":{"selector":"a.svelte-u6zczp","element_indexed":3},"chapter":{"selector":"h1"},"content":{"selector":".reader"},"next_button":{"selector":"a[data-kbd=\"⌃→\"]","value":"href"},"pre_button":{"selector":"a[data-kbd=\"⌃←\"]","value":"href"},"html_removes":[{"selector":".reader ruby, .reader rt, .reader x-z"}],"data_ready_checker":["svelte-19z0z8p _dirty"]};
  const VERSION = 3;
  const ENGINE = 3;
