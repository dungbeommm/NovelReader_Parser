/* NovelReader source: www.lacatruyen.vip | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.lacatruyen.vip/images/logo/logo-laca-192.webp","domain":"www.lacatruyen.vip","keys":["lacatruyen","www.lacatruyen.vip"],"use_html_parser":true,"use_webview":true,"title":{"selector":".chapter_chapter-content__info__JNMCs a"},"chapter":{"selector":"h1"},"content":{"selector":".chapter-content-element"},"next_button":{"selector":".chapter_mobile-bottom-bar__nav--next__r_5a0","action":1,"value":"href"},"pre_button":{"selector":".chapter_mobile-bottom-bar__nav__9kvzr","action":1,"value":"href"},"detail_first_chapter_js":"(function(){try{var d=document.getElementById('__NEXT_DATA__');if(!d)return'';var p=JSON.parse(d.textContent||'{}').props.pageProps||{};var s=p.firstChapter&&p.firstChapter[0]&&p.firstChapter[0].slug;return s?location.origin+'/chapter/'+s:'';}catch(e){return'';}})()"};
  const VERSION = 4;
  const ENGINE = 4;
