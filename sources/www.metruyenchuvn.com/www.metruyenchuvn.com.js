/* NovelReader source: www.metruyenchuvn.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.metruyenchuvn.com","keys":["metruyenchuvn.com","www.metruyenchuvn.com"],"logo":"https://metruyenchuvn.com/images/logo.png","use_html_parser":true,"use_webview":true,"title":{"selector":".current-book"},"chapter":{"selector":".current-chapter"},"content":{"selector":"article"},"next_button":{"selector":"#gotochap a.next","value":"href"},"pre_button":{"selector":"#gotochap a.back","value":"href"},"detail_first_chapter":{"selector":"#chapter-list li:first-child a","value":"href"},"detail":{"name":{"selector":"h1"},"author":{"selector":"[itemProp=author], [itemprop=author]"},"description":{"selector":"[itemProp=description], [itemprop=description]"},"genres":{"selector":"[itemProp=genre], [itemprop=genre]"}},"cover":{"selector":"[itemProp=thumbnailUrl], meta[itemprop=thumbnailUrl]","value":"content"}};
  const VERSION = 4;
  const ENGINE = 4;
