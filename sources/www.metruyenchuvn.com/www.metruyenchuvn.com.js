/* NovelReader source: www.metruyenchuvn.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.metruyenchuvn.com","keys":["metruyenchu.com.vn","metruyenchuvn.com","www.metruyenchuvn.com"],"use_html_parser":true,"use_webview":true,"title":{"selector":".current-book"},"chapter":{"selector":".current-chapter"},"content":{"selector":".truyen"},"next_button":{"selector":"#gotochap a.next","value":"href"},"pre_button":{"selector":"#gotochap a.back","value":"href"},"detail_first_chapter":{"selector":"#chapter-list li:first-child a","value":"href"},"detail":{"name":{"selector":"h1"},"author":{"selector":"a[href*='tac-gia']"},"description":{"selector":"[itemprop=description], .story-detail, .desc-text"},"genres":{"selector":"a[href*='the-loai']"}},"toc":{"selector":".list-chapter a, .chapter-list a"}};
  const VERSION = 3;
  const ENGINE = 3;
