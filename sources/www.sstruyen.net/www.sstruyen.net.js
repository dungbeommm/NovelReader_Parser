/* NovelReader source: www.sstruyen.net | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.sstruyen.net","key":"sstruyen","use_html_parser":true,"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".clearfix.lstbtn a","value":"href"},"keys":["sstruyen.com","sstruyen.vn","www.sstruyen.net"],"detail":{"name":{"selector":"h1.title, .truyen-title"},"author":{"selector":"a[itemprop=author], .info a[href*='tac-gia']"},"description":{"selector":".description, .desc-text, div[itemprop=description]"},"genres":{"selector":"a[itemprop=genre], .info a[href*='the-loai']"}},"toc":{"selector":".list-chapter li a, .chapter-list a"}};
  const VERSION = 3;
  const ENGINE = 3;
