/* NovelReader source: www.sstruyen.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv30x4ZZLE9K-JhHGkoYPBiyGtOMhz2aGJIw&s","domain":"www.sstruyen.net","key":"sstruyen","use_html_parser":true,"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".clearfix.lstbtn a","value":"href"},"keys":["www.sstruyen.net"],"detail":{"name":{"selector":"h1.title, .wrap-detail h1"},"author":{"selector":".content1 div.info a, .info a"},"description":{"selector":".content1"},"status":{"selector":".content1 .status, .status"}},"cover":{"selector":".wrap-detail.pc img, .wrap-detail img","value":"data-pagespeed-high-res-src","fallback_value":"src"},"toc":{"selector":"div.list-chap ul li a"},"search":{"url":"https://www.sstruyen.net/tim-truyen/%s","item":{"selector":".table-list tr"},"title":{"selector":".info h3 a"},"link":{"selector":"a","value":"href"},"cover":{"selector":"img","value":"src"}}};
  const VERSION = 4;
  const ENGINE = 4;
