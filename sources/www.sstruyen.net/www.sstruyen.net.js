/* NovelReader source: www.sstruyen.net | Generated from app parser.json. */
(function (global) {
  "use strict";

  const config = {"domain":"www.sstruyen.net","key":"sstruyen","use_html_parser":true,"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".clearfix.lstbtn a","value":"href"},"keys":["sstruyen.com","sstruyen.vn","www.sstruyen.net"]};
  const VERSION = 2;
