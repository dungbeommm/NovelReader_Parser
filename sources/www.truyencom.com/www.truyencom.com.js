/* NovelReader source: www.truyencom.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.truyencom.com","keys":["truyencom.com","www.truyencom.com","truyencom.blerino.com"],"use_html_parser":true,"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-c"},"next_button":{"selector":"a#next_chap","value":"href","element_indexed":0},"pre_button":{"selector":"a#prev_chap","value":"href","element_indexed":0},"detail_first_chapter":{"selector":".list-chapter li:first-child a","value":"href"}};
  const VERSION = 3;
  const ENGINE = 3;
