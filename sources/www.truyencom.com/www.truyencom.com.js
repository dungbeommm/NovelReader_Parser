/* NovelReader source: www.truyencom.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.truyencom.com","keys":["truyencom.blerino.com","truyencom.com","www.truyencom.com"],"logo":"https://cdn.truyencom.com/truyencom_logo.png","use_html_parser":true,"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-c"},"next_button":{"selector":"a#next_chap","value":"href","element_indexed":0},"pre_button":{"selector":"a#prev_chap","value":"href","element_indexed":0},"detail_first_chapter":{"selector":".list-chapter li:first-child a","value":"href"}};
  const VERSION = 4;
  const ENGINE = 4;
