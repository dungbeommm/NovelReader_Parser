/* NovelReader source: www.truyenmoikk.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.truyenmoikk.com","keys":["truyenmoikk","truyenmoiqq","truyenmoiss","www.truyenmoikk.com"],"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"use_html_parser":true,"chapter_ignore_domain":true,"detail_first_chapter":{"selector":"#firstChapter","value":"href"},"logo":"https://truyenmoikk.com/favicon.ico"};
  const VERSION = 4;
  const ENGINE = 4;
