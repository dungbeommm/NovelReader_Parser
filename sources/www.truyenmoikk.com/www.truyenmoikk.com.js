/* NovelReader source: www.truyenmoikk.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.truyenmoikk.com","keys":["truyenmoikk","truyenmoiqq","truyenmoiss"],"title":{"selector":".truyen-title"},"chapter":{"selector":".chapter-title"},"content":{"selector":".chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"use_html_parser":true,"chapter_ignore_domain":true,"detail_first_chapter":{"selector":"#firstChapter","value":"href"},"search":{"url":"https://www.truyenmoikk.com/tim-kiem/?tukhoa=%s","urls":["https://www.truyenmoikk.com/tim-kiem/?tukhoa=%s","https://www.truyenmoikk.com/?s=%s"],"item":{"selector":".list-truyen .row, .row, .book-item, .story-item, .truyen-item, article, li"},"title":{"selector":"h3 a, h2 a, .truyen-title a, .book-title a, .title a, a[title]"},"link":{"selector":"h3 a, h2 a, .truyen-title a, .book-title a, .title a, a[title]","value":"href"},"cover":{"selector":"img","value":"src"},"story_url_regex":"^https?://[^/]+/[a-z0-9][a-z0-9-]{2,}/?$","exclude_url_regex":"(chuong|chapter|/tim-kiem|/tim-truyen|/the-loai|/danh-sach|/tac-gia|/tag/|/category/|/page/|\\?s=|/dang-nhap|/dang-ky|/lien-he|/user)","story_url_templates":["https://www.truyenmoikk.com/%d/","https://www.truyenmoikk.com/truyen/%d/"],"generated":true}};
  const VERSION = 3;
  const ENGINE = 3;
