/* NovelReader source: www.truyenyy.co | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.google.com/s2/favicons?domain=truyenyy.co&sz=128","domain":"www.truyenyy.co","keys":["truyenyy.co","www.truyenyy.co"],"use_html_parser":true,"title":{"selector":"a.left-4","value":"text"},"chapter":{"selector":"h1"},"content":{"selector":"div#inner_chap_content_1, .chap-content, #inner_chap_content_1"},"next_button":{"selector":"a.yy-btn.btn-active","value":"href","element_indexed":0},"pre_button":{"selector":"a.yy-btn.btn-normal","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a.bg-primarySecond","value":"href"},"chapter_ignore_domain":false,"enable_download":false,"detail":{"name":{"selector":"div.info h1, h1"},"author":{"selector":"div.info a[href*=tac-gia], div.info .author"},"description":{"selector":"#summary_markdown, section#id_novel_summary"},"status":{"selector":".novel-meta, div.info"}},"cover":{"selector":".novel-cover img, div.novel-info img","value":"src","fallback_value":"data-src"},"toc":{"selector":".novel-detail > .weui-cells > a.weui-cell, tbody tr a"}};
  const VERSION = 4;
  const ENGINE = 4;
