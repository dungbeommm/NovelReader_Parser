/* NovelReader source: www.truyenyy.co | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.truyenyy.co","keys":["truyenyy.co","truyenyy.com","truyenyy.vip","truyenyy.xyz","www.truyenyy.co"],"use_html_parser":true,"title":{"selector":"a.left-4","value":"text"},"chapter":{"selector":"h1"},"content":{"selector":"article"},"next_button":{"selector":"a.yy-btn.btn-active","value":"href","element_indexed":0},"pre_button":{"selector":"a.yy-btn.btn-normal","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"a.bg-primarySecond","value":"href"},"chapter_ignore_domain":false,"detail":{"name":{"selector":"h1.name, h1"},"author":{"selector":"a[href*='/tac-gia/']"},"description":{"selector":".content .story-detail, #id_novel_summary, .summary"},"genres":{"selector":"a[href*='/the-loai/']"}},"toc":{"selector":".chap-list a, .list-chapters a"}};
  const VERSION = 3;
  const ENGINE = 3;
