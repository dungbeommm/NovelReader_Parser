/* NovelReader source: www.tvtruyen.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://www.tvtruyen.com/public/assets/images/logo-truyentv.webp","domain":"www.tvtruyen.com","may_need_vpn":true,"use_html_parser":true,"use_webview":true,"chapter_ignore_domain":true,"key":"tvtruyen","title":{"selector":".truyen-title"},"data_loading_checker":["<div id=\"chapter-content\" style=\"font-size:"],"chapter":{"selector":".chapter-text-info"},"content":{"selector":"#chapter-content"},"next_button":{"selector":"#next_chap","value":"href"},"pre_button":{"selector":"#prev_chap","value":"href"},"detail_first_chapter":{"selector":".comic-info-chapter a.chapter-link[href*='/chuong-']","value":"href","element_indexed":0},"keys":["www.tvtruyen.com"]};
  const VERSION = 4;
  const ENGINE = 4;
