/* NovelReader source: www.wattpad.com | Engine v3 (vBook-style rich metadata). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"www.wattpad.com","may_need_vpn":true,"keys":["wattpad.com"],"use_html_parser":true,"title":{"selector":"h2"},"chapter":{"selector":"h1"},"content":{"use_proxy":"https://novel-reader-1063262486780.asia-southeast1.run.app/redirect?origin=","selector":"p","interceptor":"wattpad"},"next_button":{"selector":"#story-part-navigation a","value":"href"},"pre_button":{"selector":"#story-part-navigation a","value":"href"},"chapter_ignore_domain":true,"detail":{"name":{"selector":"h1, .story-info h1"},"author":{"selector":"a.username, .author-info__username a"},"description":{"selector":".description-text, pre.description__text"},"genres":{"selector":".tag-items a, a[href*='/stories/']"}},"toc":{"selector":"ul.table-of-contents a, .story-parts a"}};
  const VERSION = 3;
  const ENGINE = 3;
