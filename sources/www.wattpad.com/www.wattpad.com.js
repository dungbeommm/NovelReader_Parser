/* NovelReader source: www.wattpad.com | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://static.wattpad.com/img/logos/wp-logo-orange.png","domain":"www.wattpad.com","may_need_vpn":true,"keys":["wattpad.com","www.wattpad.com"],"enable_download":false,"use_html_parser":true,"title":{"selector":"h2"},"chapter":{"selector":"h1"},"content":{"use_proxy":"https://novel-reader-1063262486780.asia-southeast1.run.app/redirect?origin=","selector":"p","interceptor":"wattpad"},"next_button":{"selector":"#story-part-navigation a","value":"href"},"pre_button":{"selector":"#story-part-navigation a","value":"href"},"chapter_ignore_domain":true,"detail":{"name":{"selector":"h1, h2"},"author":{"selector":"a[href*='/user/'], .author-info__username"},"description":{"selector":".description-text, pre.description"}},"cover":{"selector":".story-cover img, img.cover, meta[property='og:image']","value":"src"}};
  const VERSION = 4;
  const ENGINE = 4;
