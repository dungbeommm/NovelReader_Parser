/* NovelReader source: www.wattpad.com | Generated from app parser.json. */
(function (global) {
  "use strict";

  const config = {"domain":"www.wattpad.com","may_need_vpn":true,"keys":["wattpad.com"],"use_html_parser":true,"title":{"selector":"h2"},"chapter":{"selector":"h1"},"content":{"use_proxy":"https://novel-reader-1063262486780.asia-southeast1.run.app/redirect?origin=","selector":"p","interceptor":"wattpad"},"next_button":{"selector":"#story-part-navigation a","value":"href"},"pre_button":{"selector":"#story-part-navigation a","value":"href"},"chapter_ignore_domain":true};
  const VERSION = 2;
