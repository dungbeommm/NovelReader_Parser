/* NovelReader source: xtruyen.net | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"logo":"https://xtruyen.net/wp-content/uploads/2025/12/cropped-xlogox-Copy-180x180.png","domain":"xtruyen.net","keys":["www.xtruyen.vn","xtruyen","xtruyen.net"],"use_html_parser":true,"use_webview":true,"title":{"selector":"h1"},"chapter":{"selector":"h2","element_indexed":0},"content":{"selector":"#chapter-reading-content"},"next_button":{"selector":"a.next_page","value":"href"},"pre_button":{"selector":"a.prev_page","value":"href"},"data_loading_checker":[],"data_ready_checker":["loading-box"],"chapter_ignore_domain":true,"detail_first_chapter":{"selector":"#init-links a.c-btn","value":"href","element_indexed":0}};
  const VERSION = 4;
  const ENGINE = 4;
