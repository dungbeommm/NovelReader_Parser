/* NovelReader source: zingtruyen.store | Engine v4 (VBook + NovelReader APK cover/story). Auto-generated. */
(function (global) {
  "use strict";

  const config = {"domain":"zingtruyen.store","may_need_vpn":true,"keys":["www.zingtruyen.store","zingtruyen","zingtruyen.store"],"logo":"https://zingtruyen.store/asset/favicon.ico","use_html_parser":true,"title":{"selector":".story-title a"},"chapter":{"selector":"h2.chapter-title"},"content":{"selector":"#chapter-content"},"content_removes":[{"start":"Bạn đang đọc truyện trên","end":"ZingTruyen"}],"next_button":{"selector":"a.btn-next[rel=\"next\"]","value":"href","element_indexed":0},"pre_button":{"selector":"a.btn-prev[rel=\"prev\"]","value":"href","element_indexed":0},"detail_first_chapter":{"selector":"ul.chapters.v1.scroll li:first-child a","value":"href"},"chapter_ignore_domain":true};
  const VERSION = 4;
  const ENGINE = 4;
